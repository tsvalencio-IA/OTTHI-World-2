const REVISION = '8b52535600c4cb7e';
const CACHE = `otthi-v70594-${REVISION}`;
const CACHE_PREFIXES = ['otthi-','otthi-game-web-','otthos-life-world-main-'];
const BUILD = '705.16-otton-connect-progression-r16';
const VERSION = '705';
const RELEASE_MANIFEST = './release-manifest.json?v=70594';

const REQUIRED_SHELL = [
  './index.html?v=70594',
  './style.css?v=70594',
  './assets/vendor/three-r128.min.js?v=70594',
  './assets/js/core/runtime-config.js?v=70594',
  './assets/js/core/safe-pointer.js?v=70594',
  './assets/js/core/viewport-manager.js?v=70594',
  './assets/js/save-db.js?v=70594',
  './firebase-config.js?v=70594',
  './assets/js/game-account.js?v=70594',
  './assets/js/multiplayer-rtdb.js?v=70594',
  './app.js?v=70594',
  './assets/js/ui/shared-modal.js?v=70594',
  './assets/js/core/performance-guardian.js?v=70594',
  './assets/js/multiplayer/room-manager.js?v=70594',
  './assets/js/education/adaptive-learning.js?v=70594',
  './assets/js/safety/child-safety.js?v=70594',
  './manifest.webmanifest?v=70594'
];
...
async function cachedFallback(cache, request, navigation) {
  if (navigation) {
    return await cache.match('./index.html?v=70594') || await cache.match('./') || null;
  }
