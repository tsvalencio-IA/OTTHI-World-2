const REVISION = '16c92ab9cee184f4';
const CACHE = `otthi-v70609-${REVISION}`;
const CACHE_PREFIXES = ['otthi-','otthi-game-web-','otthos-life-world-main-'];
const BUILD = '705.16.7.11-shared-world-authority-yard';
const VERSION = '705';
const RELEASE_MANIFEST = './release-manifest.json?v=70609';

const REQUIRED_SHELL = [
  './index.html?v=70609',
  './style.css?v=70609',
  './assets/vendor/three-r128.min.js?v=70609',
  './assets/js/core/runtime-config.js?v=70609',
  './assets/js/core/safe-pointer.js?v=70609',
  './assets/js/core/viewport-manager.js?v=70609',
  './assets/js/save-db.js?v=70609',
  './firebase-config.js?v=70609',
  './assets/js/game-account.js?v=70609',
  './assets/js/multiplayer-rtdb.js?v=70609',
  './app.js?v=70609',
  './assets/js/ui/shared-modal.js?v=70609',
  './assets/js/core/performance-guardian.js?v=70609',
  './assets/js/multiplayer/room-manager.js?v=70609',
  './assets/js/education/adaptive-learning.js?v=70609',
  './assets/js/safety/child-safety.js?v=70609',
  './manifest.webmanifest?v=70609'
];
...
async function cachedFallback(cache, request, navigation) {
  if (navigation) {
    return await cache.match('./index.html?v=70609') || await cache.match('./') || null;
  }
