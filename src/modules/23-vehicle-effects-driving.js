...
// @otthi-module-body
  ...
  function enterVehicleAsPassenger(hostUid,vehicleId=''){
    ...
    player.preVehicleAbilities={scaleMode:player.scaleMode,crouched:player.crouched};clearMovementInputs();player.vehicle=true;player.car.id=vehicleId||target.vehicleId||'online-vehicle';player.car.kind=String(target.vehicleKind||target.vehicleBodyType||'car');player.car.label=String(target.vehicleAppearance?.label||target.vehicleLabel||'Veículo');player.car.passengerOf=hostUid;player.car.passengerUid='';player.car.passengerUids=[];player.car.passengerBotId='';player.car.hostMissingAt=0;player.car.speed=0;player.scaleMode='normal';player.crouched=false;
